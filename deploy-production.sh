...
# Mapa da Grana - Deploy Script para Produção
# Domínio: www.mapadnafinanceiro.com

set -e

echo "🔮 Mapa da Grana - Deploy para Produção"
echo "========================================"
echo "Domínio: www.mapadnafinanceiro.com"
echo ""
...
if [ ! -f "ssl/fullchain.pem" ] || [ ! -f "ssl/privkey.pem" ]; then
    ...
    print_warning "2. Obtenha certificado: certbot certonly --standalone -d www.mapadnafinanceiro.com"
    print_warning "3. Copie certificados: cp /etc/letsencrypt/live/www.mapadnafinanceiro.com/* ssl/"
    print_warning ""
...
if curl -f http://localhost &> /dev/null; then
    print_success "✅ Frontend está rodando em http://localhost"
else
...
if [ -f "ssl/fullchain.pem" ]; then
    ...
    (crontab -l 2>/dev/null; echo "0 12 * * * cd $(pwd) && docker-compose -f docker-compose.production.yml restart frontend") | crontab -
fi

print_success "🎉 Deploy concluído com sucesso!"
echo ""
echo "🌐 Aplicação disponível em:"
echo "   HTTP:  http://www.mapadnafinanceiro.com"
echo "   HTTPS: https://www.mapadnafinanceiro.com"
echo ""
echo "📋 Comandos úteis:"
echo "   Ver logs: docker-compose -f docker-compose.production.yml logs -f"
echo "   Parar: docker-compose -f docker-compose.production.yml down"
echo "   Reiniciar: docker-compose -f docker-compose.production.yml restart"
echo "   Atualizar: ./deploy-production.sh"
echo ""
echo "🔍 Monitoramento:"
echo "   Health check: curl https://www.mapadnafinanceiro.com/health"
echo "   API health: curl https://www.mapadnafinanceiro.com/api/health"
echo ""
