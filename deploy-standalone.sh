...
# Mapa da Grana - Deploy Script Standalone
# Domínio: lp.mapadnafinanceiro.com (portas padrão 80/443)

set -e

echo "🔮 Mapa da Grana - Deploy Standalone"
echo "====================================="
...
if [ -f "ssl/fullchain.pem" ]; then
    ...
    (crontab -l 2>/dev/null; echo "0 12 * * * cd $(pwd) && docker-compose -f docker-compose.standalone.yml restart frontend") | crontab -
fi
...
echo "   Atualizar: ./deploy-standalone.sh"
echo ""
echo "🔍 Monitoramento:"
