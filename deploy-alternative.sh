...
echo "   HTTP:  http://seu-ip:8080"
echo "   HTTPS: https://seu-ip:8443"
echo ""
echo "📋 Comandos úteis:"
...
echo ""
echo "🔍 Monitoramento:"
echo "   Health check: curl https://seu-ip:8443/health"
echo "   API health: curl https://seu-ip:8443/api/health"
echo ""
