...
# Mapa da Grana - Deploy Completo com Traefik
# Domínio: lp.mapadnafinanceiro.com
# Usa o Traefik existente no servidor

set -e

echo "🔮 Mapa da Grana - Deploy Completo"
echo "=================================="
...
print_status "Limpando containers parados..."
...
if curl -f http://localhost:3002/health &> /dev/null; then
    ...
    print_warning "⚠️ Backend não está respondendo diretamente (normal com Traefik)"
fi
...
if curl -f http://localhost &> /dev/null; then
    ...
    print_warning "⚠️ Frontend não está respondendo diretamente (normal com Traefik)"
fi

# Verificar logs do Traefik
print_status "Verificando logs do Traefik..."
...
echo "   Atualizar: ./deploy-complete.sh"
echo ""
echo "🔍 Monitoramento:"
